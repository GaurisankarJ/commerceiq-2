package com.commerceIQ.bookMyShow;
...
public class SwaggerConfig {
    private static final String SERVICE_TITLE = "Stock microservice";
    private static final String SERVICE_DESCRIPTION = "Look up and manage stocks for Spicejet";
    private static final String APPLICATION_VERSION = "1";
    private static final String TOS_URL = "";
    private static final String CONTACT_NAME = "Gaurisankar";
    private static final String CONTACT_URL = "https://github.com/GaurisankarJ";
